...
const NotFound: React.FC = () => {
    ...
    return (<AuthShell>
            <div className="max-w-lg w-full min-w-0 text-center px-1">
                ...
                <p className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-indigo-600/90 mb-2">{t('notFound.errorLabel')}</p>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-slate-100 mb-3">{t('notFound.title')}</h2>
                <p className="text-slate-600 dark:text-slate-400 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">{t('notFound.subtitle')}</p>
                <div className="glass-panel p-4 sm:p-6 border border-white/60 dark:border-slate-600 space-y-3 rounded-2xl">
                    <Link to="/dashboard">
