...
const Dashboard: React.FC = () => {
    ...
    return (<div className="space-y-6 sm:space-y-8 max-w-6xl mx-auto min-w-0">
            <PageHero badge="Облачное хранилище" title={user?.username ? (<>Здравствуйте, {user.username}</>) : (<>Главная</>)} subtitle="Краткая сводка по группам и файлам. Недавние действия — ниже.">
