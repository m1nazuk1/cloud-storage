...
interface AuthShellProps {
    ...
    /** Показать логотип над контентом */
    showLogo?: boolean;
}

/**
 * Общий фон для экранов входа/регистрации: мягкие «орбы» и сетка.
 */
const AuthShell: React.FC<AuthShellProps> = ({ children, showLogo = true }) => {
    return (
        <div className="relative min-h-screen min-h-[100dvh] overflow-hidden flex flex-col items-center justify-center py-8 pt-safe pb-safe px-4 sm:px-6 sm:py-10">
